...
python -m PyInstaller --noconfirm --onefile --windowed --icon="icon.ico" --add-data "icon.ico;." --add-data "icon.png;." --add-data "artplayer.js;." --name "VegaHub" "VegaHubLauncher.py"
